...
mod tests {
    ...
    #[test]
    fn test_parse_nx() {
        let commands = vec![String::from("NX")];
    ...
    #[test]
    fn test_parse_xx() {
        let commands = vec![String::from("XX")];
        let args = parse_set_arguments(&commands).unwrap();
    ...
    fn test_parse_xx_and_nx() {
        let commands = vec![String::from("XX"), String::from("NX")];
        assert!(matches!(
    ...
    fn test_parse_nx_and_xx() {
        let commands = vec![String::from("NX"), String::from("XX")];
        assert!(matches!(
            parse_set_arguments(&commands),
            Err(StorageError::CommandSyntaxError(_))
        ));
    ...
    #[test]
    fn test_parse_get() {
        let commands = vec![String::from("GET")];
        let args = parse_set_arguments(&commands).unwrap();
        assert!(args.get);
    }
    ...
    fn test_parse_nx_and_get() {
        let commands = vec![String::from("NX"), String::from("GET")];
        let args = parse_set_arguments(&commands).unwrap();
        assert_eq!(
            args,
            SetArgs {
    ...
    fn test_parse_xx_and_get() {
        let commands = vec![String::from("XX"), String::from("GET")];
        let args = parse_set_arguments(&commands).unwrap();
        assert_eq!(
            args,
            SetArgs {
    ...
    #[test]
    fn test_parse_ex() {
        let commands = vec![String::from("EX"), String::from("100")];
        let args = parse_set_arguments(&commands).unwrap();
    ...
    fn test_parse_ex_wrong_value() {
        let commands = vec![String::from("EX"), String::from("value")];
        assert!(matches!(
            parse_set_arguments(&commands),
            Err(StorageError::CommandSyntaxError(_))
        ));
    ...
    fn test_parse_ex_end_of_vector() {
        let commands = vec![String::from("EX")];
        assert!(matches!(
            parse_set_arguments(&commands),
            Err(StorageError::CommandSyntaxError(_))
        ));
    ...
    #[test]
    fn test_parse_px() {
        let commands = vec![String::from("PX"), String::from("100")];
        let args = parse_set_arguments(&commands).unwrap();
    ...
    fn test_parse_px_wrong_value() {
        let commands = vec![String::from("PX"), String::from("value")];
        assert!(matches!(
            parse_set_arguments(&commands),
            Err(StorageError::CommandSyntaxError(_))
        ));
    ...
    fn test_parse_px_end_of_vector() {
        let commands = vec![String::from("PX")];
        assert!(matches!(
            parse_set_arguments(&commands),
            Err(StorageError::CommandSyntaxError(_))
        ));
